...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf()
                ...
                .and()
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, "/mall/**", "/admin/**", "/supplier/**", "/shop/**", "/images/**")
                .permitAll()
                .antMatchers(HttpMethod.GET, "/api/mall/products")
                .permitAll()
                .antMatchers(HttpMethod.GET, "/api/mall/products/*")
                .permitAll()
                ...
                .permitAll()
                .antMatchers("/api/supplier/auth/**")
                .permitAll()
                .antMatchers("/api/admin/**")
                .hasRole("ADMIN")
                .antMatchers("/api/supplier/**")
                .hasRole("SUPPLIER")
                .antMatchers("/api/mall/cart/**", "/api/mall/orders/**")
                .hasRole("MALL_MEMBER")
                .anyRequest()
                .denyAll()
                .and()
